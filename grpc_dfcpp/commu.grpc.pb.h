...
// source: commu.proto
#ifndef GRPC_commu_2eproto__INCLUDED
#define GRPC_commu_2eproto__INCLUDED
...
class Commu final {
 public:
  ...
  class WithAsyncMethod_send_index : public BaseClass {
   ...
   public:
    WithAsyncMethod_send_index() {
      ::grpc::Service::MarkMethodAsync(0);
    }
    ~WithAsyncMethod_send_index() override {
  ...
  typedef WithAsyncMethod_send_index<Service > AsyncService;
  template <class BaseClass>
  class WithCallbackMethod_send_index : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
  ...
  template <class BaseClass>
  class WithGenericMethod_send_index : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_send_index() {
      ::grpc::Service::MarkMethodGeneric(0);
    }
    ~WithGenericMethod_send_index() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status send_index(::grpc::ServerContext* /*context*/, const ::commu::threemess* /*request*/, ::commu::reply* /*response*/) override {
  ...
  template <class BaseClass>
  class WithRawMethod_send_index : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_send_index() {
      ::grpc::Service::MarkMethodRaw(0);
    }
    ~WithRawMethod_send_index() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status send_index(::grpc::ServerContext* /*context*/, const ::commu::threemess* /*request*/, ::commu::reply* /*response*/) override {
    ...
    void Requestsend_index(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(0, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithRawCallbackMethod_send_index : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_send_index() {
      ::grpc::Service::MarkMethodRawCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->send_index(context, request, response); }));
    }
    ~WithRawCallbackMethod_send_index() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status send_index(::grpc::ServerContext* /*context*/, const ::commu::threemess* /*request*/, ::commu::reply* /*response*/) override {
  ...
  template <class BaseClass>
  class WithStreamedUnaryMethod_send_index : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ...
    ~WithStreamedUnaryMethod_send_index() override {
      BaseClassMustBeDerivedFromService(this);
    }
  ...
  typedef WithStreamedUnaryMethod_send_index<Service > StreamedService;
};

}  // namespace commu


#endif  // GRPC_commu_2eproto__INCLUDED
